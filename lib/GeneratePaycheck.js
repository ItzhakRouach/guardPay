...
// One shared hour-bucket table — see the contract comment in paycheckData.js.
// The PDF and the Paycheck modal must never drift apart again.
import { HOUR_TYPES } from "./paycheckData";
